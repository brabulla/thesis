...
\begin{itemize}
	...
	\item Két külön ütemező, külön időzítéssel, egy az ISIM lekérésekhez, egy a QRadar szinkronizációhoz.
	
	\item Kétfázisú lekérdezések, több lehetséges állapottal \todo state diagram
	\begin{itemize}
		...
		\item A QRadar szinkronizáció futása ha sikeres, akkor COMPLETED állaptba kerül a lekérdezés. Ezt az állapotot nevezzük a sikeres végállapotnak.
