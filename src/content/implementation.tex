...
A teszteléshez kézzel megadtam néhány inputot (\ref{fig:conntest1} Ábra), melyeket megkíséreltem feltölteni a connector segítségével egy Reference Data-ba (\ref{fig:conntest2} Ábra), majd ezeket ellenőriztem a QRadar belső menüjének használatával (\ref{fig:qradartest1} Ábra). 
...
\subsection{Megvalósított alkalmazás}

A végső alkalmazás egy Java webalkalmazás formájában valósult meg. 
...
%Screenshot kell e? ha igen, akkor 2017.11.21 15:24 és 15:55 közötti eseményeknél van különöböző EventID mappelésű